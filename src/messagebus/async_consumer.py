...
from messagebus.metrics import MESSAGES_PROCESSED, MESSAGES_DEAD_LETTERED, PROCESSING_TIME, start_metrics_server
...
async def start_async_consumer() -> None:
    ...
    async with connection:
        ...
        # Fix mypy by using dict[str, Any] for the arguments
        args: dict[str, Any] = {
